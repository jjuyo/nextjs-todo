...
import { 
  query, orderBy, getFirestore, collection, getDocs, getDoc, setDoc, doc, Timestamp, deleteDoc, updateDoc
...
//단일 할일 수정
export async function editATodo(id, {title, is_done}){ //바꾸고 싶은 거 받음
